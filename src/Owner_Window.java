...
public class Owner_Window extends javax.swing.JFrame {
    ...
    public Owner_Window() {
        initComponents();
        Border title_label_border = BorderFactory.createMatteBorder(0, 0, 3, 0, new Color(60,70,200));
    ...
    private void initComponents() {
        ...
        jPanel_title2.setBackground(new java.awt.Color(96, 90, 223));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 30)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Owners");
    ...
    private void jButton_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_addActionPerformed
        ...
        if(fname.trim().equals("") || lname.trim().equals("") || phone.trim().equals("") || address.trim().equals("") || email.trim().equals("")){
            JOptionPane.showMessageDialog(null, "Enter the required owner Information!", "Add Owner", 1);
        }
        else{
    ...
    private void jButton_removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_removeActionPerformed
        ...
        try{
            ...
            if (jTextField_id.getText().trim().equals("")) {
                ...
                int yes_or_no = JOptionPane.showConfirmDialog(null, "Do You Want To Delete This Owner?", "Delte Owner", JOptionPane.YES_NO_OPTION);
    ...
    private void jButton_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_editActionPerformed
        ...
        try{
            int ownerId = Integer.valueOf(jTextField_id.getText());
            if(fname.trim().equals("") || lname.trim().equals("") || phone.trim().equals("") || address.trim().equals("") || email.trim().equals("")){
                JOptionPane.showMessageDialog(null, "Enter the required owner Information!", "Edit Owner", 1);
            }
            else{
                if(owner.editOwnerData(new P_Owner(ownerId, fname, lname, phone, email, address))){
                    ...
                    JOptionPane.showMessageDialog(null, "Owner data NOT Edited", "Edit Owner", 1);
                }
            }
        }
        catch(Exception ex){
